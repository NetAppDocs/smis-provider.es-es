...
summary: El comando smis disks muestra información del disco para los sistemas de almacenamiento. Los discos smis solo funcionan cuando se utilizan con las controladoras de ONTAP 7-Mode. 
---
= discos smis
:allow-uri-read: 
:icons: font
...
[role="lead"]
 `smis disks`El comando muestra información de disco para los sistemas de almacenamiento.  `smis disks`El comando solo se admite en las controladoras ONTAP 7-Mode.
