...
image::../media/smi_s_agent_and_host_interaction.gif[Un diagrama que muestra un host enviando consultas al proveedor SMI-S CIMOM, al repositorio, a las DLL del proveedor y al sistema de almacenamiento]
